...
# ★ 全体のメインタイトル設定
plt.suptitle("Towns レビュー分析結果レポート", fontsize=18, fontweight="bold", y=0.96)
...
# 4. 画像として保存
output_path = r"C:\Users\oojin\Documents\webスクレイピング\Webscraping\date\bad\Bad- graph\Towns_graph.png"
